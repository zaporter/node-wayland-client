...
export interface Wl_display extends Interface {
  ...
  on(
    eventName: "error",
    listener: (object_id: wl_object, code: wl_uint, message: wl_string) => void,
  ): this;
...
export interface Wl_registry extends Interface {
  ...
  on(
    eventName: "global",
    listener: (name: wl_uint, interface: wl_string, version: wl_uint) => void,
  ): this;
...
export interface Wl_data_offer extends Interface {
   ...
   */
  on(
    eventName: "source_actions",
    listener: (source_actions: wl_uint) => void,
  ): this;
...
export interface Wl_data_source extends Interface {
  ...
  on(
    eventName: "send",
    listener: (mime_type: wl_string, fd: wl_fd) => void,
  ): this;
...
export interface Wl_data_device extends Interface {
  ...
  on(
    eventName: "motion",
    listener: (time: wl_uint, x: wl_fixed, y: wl_fixed) => void,
  ): this;
...
export interface Wl_shell_surface extends Interface {
  ...
  on(
    eventName: "configure",
    listener: (edges: wl_uint, width: wl_int, height: wl_int) => void,
  ): this;
...
export interface Wl_seat extends Interface {
  ...
  on(
    ...
    listener: (capabilities: wl_uint) => void,
  ): this;
...
export interface Wl_pointer extends Interface {
  ...
  on(
    eventName: "leave",
    listener: (serial: wl_uint, surface: wl_object) => void,
  ): this;
  ...
  on(
    eventName: "motion",
    listener: (time: wl_uint, surface_x: wl_fixed, surface_y: wl_fixed) => void,
  ): this;
  ...
  on(
    eventName: "axis",
    listener: (time: wl_uint, axis: wl_uint, value: wl_fixed) => void,
  ): this;
  ...
  on(
    eventName: "axis_stop",
    listener: (time: wl_uint, axis: wl_uint) => void,
  ): this;
   ...
   */
  on(
    eventName: "axis_discrete",
    listener: (axis: wl_uint, discrete: wl_int) => void,
  ): this;
...
export interface Wl_keyboard extends Interface {
  ...
  on(
    eventName: "keymap",
    listener: (format: wl_uint, fd: wl_fd, size: wl_uint) => void,
  ): this;
  ...
  on(
    eventName: "enter",
    listener: (serial: wl_uint, surface: wl_object, keys: wl_array) => void,
  ): this;
  ...
  on(
    ...
    listener: (
      serial: wl_uint,
      mods_depressed: wl_uint,
      mods_latched: wl_uint,
      mods_locked: wl_uint,
      group: wl_uint,
    ) => void,
  ): this;
   ...
   */
  on(
    eventName: "repeat_info",
    listener: (rate: wl_int, delay: wl_int) => void,
  ): this;
...
export interface Wl_touch extends Interface {
  ...
  on(
    eventName: "up",
    listener: (serial: wl_uint, time: wl_uint, id: wl_int) => void,
  ): this;
  ...
  on(
    eventName: "motion",
    listener: (time: wl_uint, id: wl_int, x: wl_fixed, y: wl_fixed) => void,
  ): this;
  ...
  on(
    eventName: "shape",
    listener: (id: wl_int, major: wl_fixed, minor: wl_fixed) => void,
  ): this;
  ...
  on(
    ...
    listener: (id: wl_int, orientation: wl_fixed) => void,
  ): this;
...
export interface Wl_output extends Interface {
  ...
  on(
    ...
    listener: (
      x: wl_int,
      y: wl_int,
      physical_width: wl_int,
      physical_height: wl_int,
      subpixel: wl_int,
      make: wl_string,
      model: wl_string,
      transform: wl_int,
